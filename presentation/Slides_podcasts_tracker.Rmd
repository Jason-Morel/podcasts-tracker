...
* Documentation complexe sur l'API Telegram, manque de temps pour créer un bot complètement automatisé\
    ...
    * Fonction pour envoyer un message sur Telegram (TelegramMessages.py sur Github)

## Interface graphique

* Création d'une interface graphique à l'aide du package Tkinter (MessageVersion.py sur Github) :
