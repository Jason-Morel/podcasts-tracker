...
from fonctions import send_telegram_message, get_telegram_message, find_episode
...
type_choice = int(get_telegram_message())
...
# récupérer la réponse de l'utilisateur
time_choice = int(get_telegram_message())
...
# Récupérer la réponse de l'utilisateur
search_word = str(get_telegram_message())
